...
$_['entry_uses_total']    = 'Uses Per Promotion:<br /><span class="help">The maximum number of times the sale can be used by any customer. Leave blank for unlimited</span>';
