...
class ModelCatalogGallimage extends Model {
	public function addGallimage($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "gallimage SET sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', gwidth = '" . (int)$data['gwidth'] . "', gheight = '" . (int)$data['gheight'] . "', pwidth = '" . (int)$data['pwidth'] . "', pheight = '" . (int)$data['pheight'] . "', awidth = '" . (int)$data['awidth'] . "', aheight = '" . (int)$data['aheight'] . "', position = '" . $this->db->escape($data['position']) . "', resize = '" . (int)$data['resize'] . "', popstyle = '" . $this->db->escape($data['popstyle']) . "', date_added = NOW()");
		...
		foreach ($data['gallimage_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "gallimage_description SET gallimage_id = '" . (int)$gallimage_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', date = '" . $this->db->escape($value['date']) . "'");
		}
	...
	public function editGallimage($gallimage_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "gallimage SET sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', gwidth = '" . (int)$data['gwidth'] . "', gheight = '" . (int)$data['gheight'] . "', pwidth = '" . (int)$data['pwidth'] . "', pheight = '" . (int)$data['pheight'] . "', awidth = '" . (int)$data['awidth'] . "', aheight = '" . (int)$data['aheight'] . "', position = '" . $this->db->escape($data['position']) . "', resize = '" . (int)$data['resize'] . "', popstyle = '" . $this->db->escape($data['popstyle']) . "', date_modified = NOW() WHERE gallimage_id = '" . (int)$gallimage_id . "'");
