<?php
// HTTP
define('HTTP_SERVER', 'http://13.229.90.238/admin/');
define('HTTP_CATALOG', 'http://13.229.90.238/');

// HTTPS
define('HTTPS_SERVER', 'http://13.229.90.238/admin/');
define('HTTPS_CATALOG', 'http://13.229.90.238/');
...
define('DB_PASSWORD', 'fashion101');
define('DB_DATABASE', 'lkw_fashion_club');
