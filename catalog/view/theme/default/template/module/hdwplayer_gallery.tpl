<div class="box" style="padding:0 20px; 0 0;">
<h2><?php echo $heading_title; ?></h2><br>
  <div id="playerG" style="height: <?php echo $height; ?>px; width: <?php echo $width; ?>px; border: 10px solid #fafafa; "><?php echo $node; ?>
</div>
<div><br></div>
  <div id="gallery"
	style="text-align: left; width: <?php echo ($img_width+14+4)*4; ?>px; background: #fafafa; border: 3px solid #fafafa; overflow: hidden;">
