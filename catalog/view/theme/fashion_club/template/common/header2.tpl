...
<div id="menu">
  <ul>
    ...
    <?php } ?>
    <!--    <li><a href="/?route=information/contest" <?php if($route=='information/media'||$route=='information/contest') echo "class=\"active\""; ?>>Contest</a></li>

	<li class="class"><a <?php if($route=='information/promotions'||$route=='information/contest') echo "class=\"active\""; ?>>Special</a>
		<ul><li><a href="/?route=information/contest">Contest Share &amp; Win</a></li>
			<li><a href="/?route=information/promotions" target="_blank">School Holiday Promotions</a></li>
			</ul>
	</li>-->
	<!--li><a href="/?route=information/promotions"  <?php if($route=='information/promotions') echo "class=\"active\""; ?>>Promotions</a></li-->
	
     <li><a href="/?route=simple_blog/article"  <?php if($route=='information/blog') echo "class=\"active\""; ?>>Blog</a></li>

   
    
    <li><a href="/?route=information/media"  <?php if($route=='information/media'||$route=='information/news') echo "class=\"active\""; ?>>Media</a></li>
    <!---<li><a href="/?route=simple_blog/article"  <?php if($route=='simple_blog/article') echo "class=\"active\""; ?>>Blog</a></li>-->
	...
	<li class="class"><a>Study Fashion</a>
		<ul><li><a href="http://www.limkokwing.net/malaysia/academic/courses_details/bachelor_of_arts_hons_in_fashion_retailing" target="_blank">Bachelor of Arts (Hons)
in Fashion & Retailing</a></li>
			<li><a href="http://www.limkokwing.net/malaysia/academic/courses_details/diploma_in_fashion_retail_design" target="_blank">Diploma in Fashion & Retail Design</a></li>
			</ul>
	</li>
  </ul>
</div>
