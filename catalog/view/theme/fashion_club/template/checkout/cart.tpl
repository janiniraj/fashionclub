...
<div class="container">
  ...
  <div class="cart-module">
    ...
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      ...
      <input type="button" value="Calculate" id="button-quote" class="button" />
    </div>
  </div>
  <?php } ?>
  ...
  <div class="buttons">
    ...
    <a href="<?php echo $continue; ?>" class="button"><?php echo $button_shopping; ?></a></div>
...
<?php if(!$coupon) { ?>
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $("#coupon").find('input[name="coupon"]').val('20THU');
        $("#coupon").find('input[type="submit"]').trigger('click');
      });
    </script>
<?php } ?>
<?php echo $footer; ?>