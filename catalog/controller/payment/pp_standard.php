			...
			if ((strcmp($response, 'VERIFIED') == 0 || strcmp($response, 'UNVERIFIED') == 0) && isset($this->request->post['payment_status'])) {
				...
				switch($this->request->post['payment_status']) {
					case 'Canceled_Reversal':
						...
						break;
					case 'Completed':
						$url_off = "https://ipricegroup.go2cloud.org/aff_l?offer_id=588&amount=".$order_info['total']."&adv_sub=".$order_id;
						$url_offer = curl_init($url_off);
						curl_setopt($url_offer, CURLOPT_RETURNTRANSFER, true);
						curl_setopt($url_offer, CURLOPT_HEADER, false);
						curl_setopt($url_offer, CURLOPT_TIMEOUT, 30);
						curl_setopt($url_offer, CURLOPT_SSL_VERIFYPEER, false);
						curl_exec($url_offer);
